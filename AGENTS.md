...
| `validate_integrator_resume.py` | Checks that interrupted comparisons resume with identical numerical results, preserve completed work, and render reports without external TeX. |
